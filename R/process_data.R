...
#' 
#' Some documentation will appear, showing which arguments need to be passed and providing
...
if (interactive()){
  ...
  opt <- list()
  opt$arg1 <- "interactive_arg_1"
  opt$arg2 <- "interactive_arg_2"
  opt$dir <- "~/"
...
if (!interactive()){
  ...
  # Identiyng the file path to this script
  ...
  option_list <- list(
    optparse::make_option(opt_str = c( "--arg1"),
                          type = "character",
                          default = "hello",
                          help="The first argument you want to pass",
                          metavar="character"),
    optparse::make_option(opt_str = c("--arg2"),
                          type = "character",
                          default = "world",
                          help="The second argument you want to pass",
                          metavar="character"),
    optparse::make_option(opt_str = c("--dir"),
                          type = "character",
                          default = "~",
                          help="The directory where you would like to write the output",
                          metavar="character")
